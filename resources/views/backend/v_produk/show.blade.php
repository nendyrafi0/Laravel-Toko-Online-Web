                                ...
                                <div id="foto-container">
                                    <div class="row">
                                        @foreach($show->fotoProduk as $fotoProduk)
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <form action="{{
                                            route('backend.foto_produk.destroy', $fotoProduk->id) }}" method="post">
                                                                                @csrf
                                                                                @method('delete')
        ...
        addFotoButton.addEventListener('click', function () {
            ...
            fotoRow.innerHTML = `
                    <form action="{{ route('backend.foto_produk.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <img src="" class="preview-img mb-2" style="max-width: 200px; display: none; padding: 2px;">
...
<script>
    function previewFoto(input) {
        ...
        const preview = input.closest('div').querySelector('.preview-img');
